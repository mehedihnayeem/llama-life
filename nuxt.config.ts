      ...
      theme: {
        extend: {
          ...
          colors: {
            ...
            customLightGray: "rgb(189, 189, 189)",
          ...
          addUtilities({
            ".border-rgb": {
              background: `repeating-linear-gradient(
                ...
                rgb(234, 97, 97) 0px,
                rgb(234, 97, 97) 45px,
                rgb(245, 133, 102) 45px,
                rgb(245, 133, 102) 90px,
                rgb(244, 171, 87) 90px,
                rgb(244, 171, 87) 135px,
                rgb(235, 200, 61) 135px,
                rgb(235, 200, 61) 180px,
                rgb(100, 203, 98) 180px,
                rgb(100, 203, 98) 225px,
                rgb(176, 123, 221) 225px,
                rgb(176, 123, 221) 270px
              );
              background-size: 100% 100%; /* Adjust to fit the element size */
